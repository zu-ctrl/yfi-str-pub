...
*/
/**
 *Think it uses same controller and same vaults for any strategy. 
*/
...
contract StrategyCreamRENBTC {
    ...
    address constant public want = address(0xeb4c2781e4eba804ce9a9803c67d0893436bb27d);
    
    Creamtroller public constant creamtroller = Creamtroller(0x3d5BC3c8d13dcB8bF317092d84783c2697AE9258);
    
    address constant public crRENBTC = address(0x17107f40d70f4470d20cb3f138a052cae8ebd4be);
